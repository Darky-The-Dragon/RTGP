/*
Es02: Opengl basic application - part 2
- as lecture01 but with:
...
N.B. 1) Model and Mesh classes follow RAII principles.

N.B. 2) no texturing in this version of the classes

N.B. 3) running this application, you will see a window all colored in red (more details in next lecture)
...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "RTGP_lecture02", nullptr, nullptr);
    if (!window)
    {
