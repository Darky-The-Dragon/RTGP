...
GLint textureLocation, cameraLocation, etaLocation, powerLocation, pointLightLocation;
...
int main()
{
  ...
  // we create the application's window
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "RTGP_lecture05b", nullptr, nullptr);
    if (!window)
    {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        textureLocation = glGetUniformLocation(reflection_shader.Program, "tCube");
        // the shaders for reflection and refraction need the camera position in world coordinates
        cameraLocation = glGetUniformLocation(reflection_shader.Program, "cameraPosition");
        etaLocation = glGetUniformLocation(reflection_shader.Program, "Eta");
        powerLocation = glGetUniformLocation(reflection_shader.Program, "mFresnelPower");
        pointLightLocation = glGetUniformLocation(reflection_shader.Program, "pointLightPosition");
