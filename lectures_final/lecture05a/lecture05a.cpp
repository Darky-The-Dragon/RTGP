...
GLint pointLightLocation, textureLocation, repeatLocation, matAmbientLocation, matSpecularLocation;  
...
int main()
{
  ...
  // we create the application's window
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "RTGP_lecture05a", nullptr, nullptr);
    if (!window)
    {
