/*
Es04a: Shaders for Lambert, Phong, Blinn-Phong and GGX illumination models
...
int main()
{
  ...
  // we create the application's window
    GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "RGP_lecture04a", nullptr, nullptr);
    if (!window)
    {
