/*
05_uv2color.frag: the Fragment shader assigns to the fragment a color based on the UV texture coordinates of the vertex (U and V are saved in R and G color channels)
author: Davide Gadia
