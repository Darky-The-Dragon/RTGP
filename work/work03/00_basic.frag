...
// Let's use the normals as shade colors
// in vec3 N; // Same name as the vertex shader. this way I link the two
...
void main()
{
    ...
    // let's write a turbolence noise (noise that relies on another noise)
    ...
    //colorFrag = vec4(vec3(r, g, b), 1.0);
    colorFrag = vec4(vec3(value), 1.0);
